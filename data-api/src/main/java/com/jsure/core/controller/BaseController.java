...
public class BaseController {
     ...
     * @return
     */
    protected Response successResult(Response r, String msg) {
     ...
     * @return
     */
    protected Response failedResult(Response r, String code, String msg) {
        r.setResCode(code);
        r.setResMsg(msg);
        return r;
    }
     ...
     * @return
     */
    protected Response failedResult(Response r) {
